...
<html>
    ...
    <body>
        <nav class="navbar navbar-dark" style="margin-bottom:2px; ">
    ...
    <nav class="navbar navbar-dark sidebar" role="navigation">
        <div class="container-fluid">
    ...
    <main id="page-content-wrapper" role="main">
        <div class="container">
            <div class="img">
                <img src="img/astec.jpg" alt="Logo Vastec" class="align-img">
            </div>
        </div>
    </main>
    </body>
